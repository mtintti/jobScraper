        ...
        <div>
            ...
            <div className=" sm:max-w-2xl mx-auto grid md:grid-cols-2 lg:grid-cols-2 gap-8 text-black-300">
                ...
                <div className="col-start-1 row-start-3 max-w-xl text-start text-zinc-900 md:text-left md:text-lg md:leading-6 md:tracking-normal">
                    With JobTracker you can easily add new job postings and track the status of all your applications. The app categorizes your job applications into different statuses such as Applied and Interview allowing you to see your progress at a glance. Our clean and user-friendly interface ensures that you can focus on your job search without getting bogged down by complexity.
                </div>
                <div className="col-start-1 row-start-4 max-w-xl text-start text-zinc-900 md:text-left md:text-lg md:leading-6 md:tracking-normal">
                    JobTracker also provides insightful analytics helping you to identify patterns in your job search and optimize your strategy.
                </div>
                ...
                <div className="col-start-2 row-start-3 max-w-xl text-start text-zinc-900 md:text-left md:text-lg md:leading-6 md:tracking-normal">
                    Join the growing community of JobTracker users today and take control of your job search journey. Let JobTracker help you stay organized and one step closer to landing your dream job. With JobTracker your next career opportunity is just a click away!
                </div>
